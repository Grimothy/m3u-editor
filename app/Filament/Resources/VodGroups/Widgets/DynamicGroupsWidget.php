        ...
        return $table
            ...
            ->bulkActions([
                BulkAction::make('cache_now')
                    ...
                    ->modalDescription(__('Queue downloads for every selected Dynamic Group now? Existing cached files are reused via fingerprint dedup; new jobs appear in the Dynamic Group Cache Activity widget below.'))
